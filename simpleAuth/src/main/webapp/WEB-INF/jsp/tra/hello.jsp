...
<body>
	<div id="dlg" class="easyui-dialog" title="Hello PmsWeb"  style="width:450px;height:200px;padding:10px">
...
<script type="text/javascript">
    // <![CDATA[
    var appForm = $('#ff');
    var httpDispatcher = '${contextPath}/tra/helloPmsWeb';
    var errorMsg = '${msg}';
	...
	var jsApp = function() {
		...
		var showLoginError = function() {
			if (errorMsg != '') {
				$.messager.alert('Hello Error',errorMsg,'error');
			}
		};
