		...
		var jsApp = function() {
			...
			var bundlePageEvent = function() {
                ...
                $('#exportBtn').on('click', function(event) {                               
                	var selected = $('#criteria_shift_code').textbox('getValue');
                     $('#shiftCode').textbox("setValue", selected);
                    appForm.attr('action', httpDispatcher + '/report/excelReport/export'); // findBy
                    appForm.submit();
                }); 
				...
				$('#createBtn').on('click', function(event) {			
	                ...
	                $('#siteShiftCode').textbox("setValue", '');
	                $('#shiftCode').textbox("setValue", '');
	                $('#personalShiftCode').textbox("setValue", '');
	                $('#shiftCodeDescription').textbox("setValue", '');
	                $('#startFrom').textbox("setValue", '');
	                $('#untilTo').textbox("setValue", '');
	                $('#actualWorkHours').textbox("setValue", '');
	                $('#breakfast').combobox("setValue", '');
	                $('#morningCommute').combobox("setValue", '');
	                $('#dinner').combobox("setValue", '');
	                $('#nightCommute').combobox("setValue", '');
				...
				$('#saveBtn').on('click', function(event) {	
					...
					if(valid) {
						if($('#id').val() == '') {
							appForm.attr('action', httpDispatcher + '/psp/shiftCode/create');	// create 						
							appForm.submit();  
						} else {
							appForm.attr('action', httpDispatcher + '/psp/shiftCode/update'); // update
							appForm.submit();
						}
				...
				$('#deleteBtn').on('click', function(event) {
					...
					appForm.attr('action', httpDispatcher + '/psp/shiftCode/delete'); // delete
					appForm.submit();					
				});		
				//Cancel Button
