        ...
        <div id="southPannel"  style="height:200px;"> 
            <div class="easyui-panel" title="Data Input" style="width:100%;max-width:100%;padding:30px 60px;">
                    <div style="margin-bottom:20px">
                        ...
                        <tr>
                            <td style="font-weight:bold;">Date</td><td>Shift</td><td>Rev.</td><td>Rest.</td><td>AirCraft</td><td>Note</td><td>Section</td><td>Team</td><td>&nbsp;&nbsp;&nbsp;</td>
                            <td style="font-weight:bold;">Date</td><td>Shift</td><td>Rev.</td><td>Rest.</td><td>AirCraft</td><td>Note</td><td>Section</td><td>Team</td><td>&nbsp;&nbsp;&nbsp;</td>
                            <td style="font-weight:bold;">Date</td><td>Shift</td><td>Rev.</td><td>Rest.</td><td>AirCraft</td><td>Note</td><td>Section</td><td>Team</td><td>&nbsp;&nbsp;&nbsp;</td>
                        </tr>                         
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="01_restShiftCode"   name="01_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="01_acRegistr"       name="01_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="11_restShiftCode"   name="11_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="11_acRegistr"       name="11_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="21_restShiftCode"   name="21_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="21_acRegistr"       name="21_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="02_restShiftCode"   name="02_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="02_acRegistr"       name="02_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="12_restShiftCode"   name="12_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="12_acRegistr"       name="12_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="22_restShiftCode"   name="22_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="22_acRegistr"       name="22_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="03_restShiftCode"   name="03_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="03_acRegistr"       name="03_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="13_restShiftCode"   name="13_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="13_acRegistr"       name="13_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="23_restShiftCode"   name="23_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="23_acRegistr"       name="23_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="04_restShiftCode"   name="04_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="04_acRegistr"       name="04_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="14_restShiftCode"   name="14_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="14_acRegistr"       name="14_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="24_restShiftCode"   name="24_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="24_acRegistr"       name="24_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="05_restShiftCode"   name="05_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="05_acRegistr"       name="05_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="15_restShiftCode"   name="15_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="15_acRegistr"       name="15_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="25_restShiftCode"   name="25_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="25_acRegistr"       name="25_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="06_restShiftCode"   name="06_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="06_acRegistr"       name="06_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="16_restShiftCode"   name="16_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="16_acRegistr"       name="16_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="26_restShiftCode"   name="26_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="26_acRegistr"       name="26_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="07_restShiftCode"   name="07_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="07_acRegistr"       name="07_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="17_restShiftCode"   name="17_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="17_acRegistr"       name="17_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="27_restShiftCode"   name="27_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="27_acRegistr"       name="27_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="08_restShiftCode"   name="08_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="08_acRegistr"       name="08_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="18_restShiftCode"   name="18_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="18_acRegistr"       name="18_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="28_restShiftCode"   name="28_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="28_acRegistr"       name="28_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="09_restShiftCode"   name="09_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="09_acRegistr"       name="09_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="19_restShiftCode"   name="19_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="19_acRegistr"       name="19_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="29_restShiftCode"   name="29_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="29_acRegistr"       name="29_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="10_restShiftCode"   name="10_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="10_acRegistr"       name="10_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="20_restShiftCode"   name="20_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="20_acRegistr"       name="20_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                            ...
                            <td><input class="easyui-textbox" id="30_restShiftCode"   name="30_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="30_acRegistr"       name="30_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" id="31_restShiftCode"   name="31_restShiftCode"   style="width:30px" validType="length[2,2]" invalidMessage="長度需等於2" ></td>
                            <td><input class="easyui-textbox" id="31_acRegistr"       name="31_acRegistr"       style="width:60px" validType="length[0,8]" invalidMessage="長度需小於等於8"></td>
        ...
        var jsApp = function() {
            ...
            var bundlePageEvent = function() {
                ...
                $('#saveBtn').on('click', function(event) { 
                    ...
                    if(valid) {
                        $.ajax({
                            url: httpDispatcher + '/psp/personalShift/setBy',
                            data: appForm.serialize(),
                            type:"POST",
                            dataType:'json',
                            success: function(data){
                            	$.ajax({
                                    url: httpDispatcher + '/psp/personalShift/setLastBy',
                                    data: appForm.serialize(),
                                    type:"POST",
                                    dataType:'json',
                                    success: function(data){
            ...
            return {
                ...
                ajax_findAll : function() {
                    $('#dg').datagrid({
                        url: httpDispatcher +'/psp/personalShift/indexList',
                        method:'post',
                        rownumbers:true,
                        pagination:true,
                        singleSelect:true,
